...
if (stripeKey && stripeKey.startsWith('sk_')) {
    try {
        exports.stripe = stripe = new stripe_1.default(stripeKey, { apiVersion: '2024-06-20' });
        console.log('✅ Stripe initialized');
    }
    catch (e) {
        console.warn('⚠️ Failed to initialize Stripe:', e);
        exports.stripe = stripe = null;
    }
}
else {
...
function getStripe() {
    ...
    stripeInstance = new stripe_1.default(apiKey, { apiVersion: '2024-06-20' });
    return stripeInstance;
}
/**
