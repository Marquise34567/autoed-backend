...
exports.getUserPlanUsage = getUserPlanUsage;
exports.setUserPlan = setUserPlan;
exports.incrementRenderUsage = incrementRenderUsage;
exports.checkRenderAllowance = checkRenderAllowance;
exports.getRenderUsageString = getRenderUsageString;
exports.getUserIdFromRequest = getUserIdFromRequest;
exports.getServerUserPlanUsage = getServerUserPlanUsage;
exports.serverIncrementRenderUsage = serverIncrementRenderUsage;
 ...
 */
function checkRenderAllowance() {
    const usage = getUserPlanUsage();
    const plan = (0, plans_1.getPlan)(usage.planId);
 ...
 */
function getServerUserPlanUsage(userId = DEMO_USER_ID) {
 ...
 */
function serverIncrementRenderUsage(userId = DEMO_USER_ID) {
    // Stub: use same increment. In production: atomic DB increment with transaction.
    return incrementRenderUsage();
}
// ============ Private helpers ============
function getDefaultPlanUsage() {
    return {
        userId: DEMO_USER_ID,
        planId: plans_1.PLAN_IDS.FREE,
