...
exports.probeDurationSec = probeDurationSec;
exports.detectSilenceSegments = detectSilenceSegments;
exports.selectBoringCuts = selectBoringCuts;
exports.analyzeVideo = analyzeVideo;
const child_process_1 = require("child_process");
function runProcess(cmd, args, opts = {}) {
    return new Promise((resolve, reject) => {
        const cp = (0, child_process_1.spawn)(cmd, args, { stdio: ['ignore', 'pipe', 'pipe'], ...opts });
        let stdout = '';
        let stderr = '';
...
async function detectSilenceSegments(inputPath) {
...
function selectBoringCuts(durationSec, silenceSegments) {
